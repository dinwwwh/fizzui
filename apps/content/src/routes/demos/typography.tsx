import { DemoContainer } from '@content/components/demo'
import { caption, display, text, title } from '@fizzui/styles'
import { createFileRoute } from '@tanstack/react-router'

export const Route = createFileRoute('/demos/typography')({
